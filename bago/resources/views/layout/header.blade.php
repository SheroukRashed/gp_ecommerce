...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <link rel="stylesheet" href="AdminLTE-2.4.10/bower_components/Ionicons/c/css/ionicons.min.css">
        <!-- Theme style -->
    ...
    <!-- FastClick -->
    <script src="AdminLTE-2.4.10/plugins/fastclick/fastclick.min.js"></script>
    <!-- AdminLTE App -->
